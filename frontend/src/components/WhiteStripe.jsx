...
export const WhiteStripe = () => {
	...
	const [imageName, setImageName] = useState("white-stripe-res.nii"); // Estado para almacenar el nombre de la imagen
    ...
    let getHistogram = async () => {
        if (input.histogram) {
            setInput({ ...input, histogram: false });
        }
        setTimeout(() => {
             setInput({ ...input, histogram: true });
         }, 1000);
	...
	return (
		<div className="flex flex-col items-center justify-center mt-9">
			...
			<h1 className="text-lg font-bold text-black m-4">White stripe</h1>
            ...
            {input.histogram && (
                <div className='flex flex-row'>
                    ...
                    <img className='flex flex-col mx-2' src={"http://localhost:8000/image/histogram/"+imageName} alt="histogram white.stripe" />
